...
document.getElementById("about").addEventListener("click", myFunction); //adding click function to element
function myFunction() {
  document.getElementById("mainbox").src = "https://www.searchblock.cf/about"; //changing mainbox's src
}
//end of change

 document.getElementById("pgs").addEventListener("click", myFunction); //adding click function to element
function myFunction() {
  document.getElementById("mainbox").src = "https://www.searchblock.cf/pgs"; //changing mainbox's src
}
//end of change

 document.getElementById("bing").addEventListener("click", myFunction); //adding click function to element
function myFunction() {
  document.getElementById("mainbox").src = "https://www.searchblock.cf/bing"; //changing mainbox's src
}
//end of change

 document.getElementById("music").addEventListener("click", myFunction); //adding click function to element
function myFunction() {
